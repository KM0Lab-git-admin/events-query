...
CREATE TABLE IF NOT EXISTS `NOTICIAS_MASTER` (
  ...
  `Cuerpo_ES` TEXT NULL,
  `Resumen_CAT` VARCHAR(500) NULL COMMENT 'Resumen 2-3 frases para tarjetas (generado por LLM)',
  `Resumen_ES` VARCHAR(500) NULL COMMENT 'Resumen 2-3 frases para tarjetas (generado por LLM)',
  `Tags_CAT` JSON NULL,
  `Tags_ES` JSON NULL,
